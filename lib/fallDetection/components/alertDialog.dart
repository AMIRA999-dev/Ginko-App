    ...
    return Column(
      children: [
        ...
        Container(
          ...
          width: 220,
          child: SlideAction(
            sliderButtonIcon: SvgPicture.asset('assets/images/scroll.svg'),
            text: ' call for help',
            textStyle: TextStyle(
              color: ThirdColor,
              fontFamily: 'RedHatDisplay-Bold',
            ...
            innerColor:  Color.fromRGBO(12, 4, 64, 1),
            sliderButtonIconSize: 2,
outerColor: Color.fromRGBO(12, 4, 64, 1) ,
            borderRadius: 20,
            height: 50,
